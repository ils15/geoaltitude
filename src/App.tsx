                ...
                <tbody>
                  {history.map((item, index) => (
                    <tr key={index} className="border-b border-slate-100 dark:border-slate-800/50 last:border-0 hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="px-4 py-3 font-mono font-medium text-indigo-600 dark:text-indigo-400">{item.fator_conversao} m</td>
                      <td className="px-4 py-3 font-mono font-medium text-emerald-600 dark:text-emerald-400">{item.H !== undefined ? `${item.H.toFixed(3)} m` : '-'}</td>
